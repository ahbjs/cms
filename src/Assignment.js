        ...
        {ResData.map((data) => {
            return(
                      <tr>
                        ...
                        <td>
                            <a href={"http://localhost:9000/download?fileType=a&id=" + data.assID} target="_blank" download><button type="button" className="btn btn-primary">Download</button></a>
                        </td>
                        <td><a href={"../editassignment/" + data.assID}><button className="btn btn-info btn-bind-left">Edit</button></a><button className="btn btn-warning btn-bind-right" type="submit" value={data.assID} onClick={(e) => this.handleDelete(e)}>Delete</button></td>
                      </tr>
